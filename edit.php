...
<h5>Product Id</h5> <input class="contact-form-text" type= "text" name="rollno" value="<?php echo $_GET['rn'];?>"/><br>
<h5>Product Name </h5><input  class="contact-form-text" type= "text" name="studentname" value="<?php echo $_GET['sn'];?>"/><br>
<h5>Product Price </h5><input class="contact-form-text" type= "text" name="class" value="<?php echo $_GET['cl'];?>"/><br>
<h5>Product Code</h5> <input class="contact-form-text" type= "text" name="code" value="<?php echo $_GET['co'];?>"/><br>
<h5>Product Discount </h5><input class="contact-form-text" type= "text" name="discount" value="<?php echo $_GET['dis'];?>"/><br> 
<h5>Product Details </h5><input class="contact-form-textarea" name="text" rows="5" cols="20" value="<?php echo $_GET['tex'];?>" /><br> 
...
<input class="contact-form-btn" type="submit" name="submit" value="Update"/>
	</form>
	</div>
	<?php
...
$e=$_GET['text'];
$i=$_GET['radio'];
       $query= "UPDATE tblproduct SET name='$s' , price='$c' , productcode='$o' ,productdiscount='$d' , productdetails='$e' , instock='$i' where id='$r'";
	   $data=mysqli_query($con, $query);
	   if($data)
	{
		echo"recoreds updated successfully";
	}
	else
	{
		echo"recoreds not updated successfully";
	}
}
else 
{
