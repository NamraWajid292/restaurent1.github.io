...
<h5>User Id</h5> <input class="contact-form-text" type= "text" name="rollno" value=""/><br>
<h5>Profile Name </h5><input  class="contact-form-text" type= "text" name="studentname" value=""/><br>
<h5>User Name </h5><input class="contact-form-text" type= "text" name="class" value=""/><br>
<h5>Mobile Number</h5> <input class="contact-form-text" type= "text" name="code" value=""/><br>
<h5>E-mail </h5><input class="contact-form-text" type= "text" name="discount" value=""/><br> 
<h5>password </h5><input class="contact-form-text" type= "password" name="text" value=""/><br> 
<input class="contact-form-btn" type="submit" name="submit" value="submit"/>
	</form>
	</div>
	<?php
 if(isset($_POST['submit']))
{
	...
	$dis=$_POST['discount'];
	$tex=$_POST['text'];
	if($rn !="" && $sn !=""  && $cl !="" && $co !="" && $dis!="" && $tex!="")
	{
	$query="INSERT INTO tbladmin VALUES('$rn','$sn','$cl','$co','$dis','$tex')";
